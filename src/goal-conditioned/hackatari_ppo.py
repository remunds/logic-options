...
if __name__ == "__main__":
    ...
    envs = gym.vector.AsyncVectorEnv(
        # [make_hackatari_env(args.env_id, i, args.capture_video, run_name) for i in range(args.num_envs)],
        [make_hackatari_env(args.env_id, i) for i in range(args.num_envs)],
    )
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                b_obs2 = b_obs[mb_inds].view(args.minibatch_size, -1)
                _, newlogprob, entropy, newvalue = agent.get_action_and_value(b_obs2, b_actions.long()[mb_inds])
